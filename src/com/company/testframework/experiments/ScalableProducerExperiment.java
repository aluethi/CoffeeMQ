...
public class ScalableProducerExperiment extends Experiment {
    ...
    public void setUp(String[] args) {
        ...
        messageSize_ = Integer.parseInt(args[4]);
    ...
    public class Producer implements Runnable {
        ...
        public void run() {
            ...
            switch(messageSize_) {
                case 250:
                    messageToSend = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890" +
            ...
            Message msg = new Message(0,0,0,messageToSend);
